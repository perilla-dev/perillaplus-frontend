<template>
  <v-sheet :color="isDark ? '#1F1F1F' : 'grey lighten-5'" :dark="isDark" :rounded="rounded" class="app-code overflow-hidden" dir="ltr" outlined>
    <slot />
...
<script>
// Utilities
import AppCopyBtn from '@/components/vuetify/AppCopyBtn.vue'
